...
scenes.createScene(
    ...
    [{ description: "Not so friendly neighborhood", scene: "Scene_II"},]
    )
...
scenes.createScene(
    ...
    [{ description: "Wild Wolf", scene: "Scene_III"}]
    )
...
scenes.createScene(
    ...
    [{ description: "Cold Days Ahead", scene: "Scene_IV"}]
    )
...
scenes.createScene(
    ...
    [{ description: "Nearby town", scene: "Scene_V"}]
    )
...
scenes.createScene(
    ...
    [{ description: "You have survived", scene: "Scene_VI"}]
    )
